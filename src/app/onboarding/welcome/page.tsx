      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[rgba(255,255,255,0.08)] border-b border-white/10 backdrop-blur-md">
        <div className="max-w-[var(--spacing-container-max)] mx-auto px-[var(--spacing-sm)] md:px-[var(--spacing-xl)] h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-[var(--spacing-md)]">
            <button className="text-[var(--color-secondary)]/60 hover:text-[var(--color-secondary)] transition-colors p-1">
              <span className="material-symbols-outlined">notifications</span>
            </button>
            <div className="flex items-center gap-[var(--spacing-sm)] pl-[var(--spacing-md)] border-l border-white/10">
              <div className="w-8 h-8 rounded-full border border-[var(--color-secondary)]/30 p-0.5">
                <span className="material-symbols-outlined text-[var(--color-secondary)] text-[24px] flex items-center justify-center">account_circle</span>
              </div>
              <span className="font-inter text-sm font-semibold text-[var(--color-secondary)] hidden md:block">Commander</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <footer className="relative z-10 w-full bg-[var(--color-surface-container-lowest)]/40 backdrop-blur-md border-t border-white/10 mt-auto">
        <div className="max-w-[var(--spacing-container-max)] mx-auto flex flex-col md:flex-row justify-between items-center px-[var(--spacing-xl)] py-[var(--spacing-lg)] gap-[var(--spacing-md)]">
          ...
          <div className="flex gap-[var(--spacing-md)]">
            <Link className="font-inter text-xs text-[var(--color-on-surface-variant)] hover:text-[var(--color-secondary)] transition-transform hover:-translate-y-[2px]" href="#">Privacy Policy</Link>
            <Link className="font-inter text-xs text-[var(--color-on-surface-variant)] hover:text-[var(--color-secondary)] transition-transform hover:-translate-y-[2px]" href="#">Terms of Service</Link>
            <Link className="font-inter text-xs text-[var(--color-on-surface-variant)] hover:text-[var(--color-secondary)] transition-transform hover:-translate-y-[2px]" href="#">Sustainability</Link>
            <Link className="font-inter text-xs text-[var(--color-on-surface-variant)] hover:text-[var(--color-secondary)] transition-transform hover:-translate-y-[2px]" href="#">Global Lounges</Link>
          </div>
        </div>
      </footer>
    </div>
